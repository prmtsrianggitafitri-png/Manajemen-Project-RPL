      ...
      <div class="header-right d-flex align-items-center gap-3 m-0 p-0">
        <form action="{{ route('home') }}" method="GET" class="d-flex align-items-center m-0">
          <div class="position-relative">
            <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="Search..." style="padding-right: 35px;">
            <button type="submit" class="btn p-0 position-absolute end-0 top-50 translate-middle-y me-2" style="border: none; background: none;">
